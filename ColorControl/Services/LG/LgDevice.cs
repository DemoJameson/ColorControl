...
namespace ColorControl.Services.LG
{
    class LgDevice
    {
        ...
        private void UpdateOptions(LgDeviceOptions options)
        {
            ...
            PowerOnAfterSessionUnlock = options.PowerOnAfterSessionUnlock;
            PowerOffAfterSessionLock = options.PowerOffAfterSessionLock;
        ...
        private async ValueTask DisposeConnection()
        {
            if (_lgTvApi != null)
            {
                await _lgTvApi.DisposeAsync();
                _lgTvApi = null;
            }
        }
        ...
        public List<InvokableAction> GetInvokableActionsForGameBar()
        {
            ...
            return actions.Where(a =>
                                 ...
                                 a.Name == "audioVolume" || (a.Category == "other" && (a.MinValue < a.MaxValue || a.EnumType != null))
                                 )
                          .ToList();
        }
        ...
        private Task<bool> WakeAction(Dictionary<string, object> _)
        {
