...
public class ColorProfileService
{
    ...
    public ColorProfileDto GetColorProfile(string name, string displayName = null)
    {
        ...
        {
            Name = name,
            RenderingIntent = data.RenderingIntent,
            ...
            ShadowDetailRange = data.ShadowDetailRange,
            RedGain = data.RedGain,
            GreenGain = data.GreenGain,
            BlueGain = data.BlueGain,
    ...
    public bool UpdateColorProfile(ColorProfileDto colorProfile, string displayName = null)
    {
        ...
        {
            RenderingIntent = colorProfile.RenderingIntent,
            ...
            ShadowDetailRange = colorProfile.ShadowDetailRange,
            RedGain = colorProfile.RedGain,
            GreenGain = colorProfile.GreenGain,
            BlueGain = colorProfile.BlueGain,
