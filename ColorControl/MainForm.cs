...
namespace ColorControl
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(GlobalContext globalContext, ServiceManager serviceManager, IServiceProvider serviceProvider, ElevationService elevationService,
            KeyboardShortcutDispatcher keyboardShortcutDispatcher, UpdateManager updateManager, WindowMessageDispatcher windowMessageDispatcher)
        {
            InitializeComponent();
        ...
        {
            await _updateManager.InstallUpdate();
        }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            if ((keyData == (Keys.Control | Keys.PageUp) || keyData == (Keys.Control | Keys.PageDown)) && KeyboardShortcutDispatcher.IsShortcutControlFocused())
            {
                ...
                if (control != null)
                {
                    ...
                    control.Text = KeyboardShortcutDispatcher.FormatKeyboardShortcut(keyEvent);
                }
